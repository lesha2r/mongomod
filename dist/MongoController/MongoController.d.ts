...
declare class MongoController {
    ...
    deleteOne(options: MethodDeleteOneOptions): Promise<import("../QueryResult.js").default<null> | import("../QueryResult.js").default<import("mongodb").WithId<import("bson").Document>>>;
