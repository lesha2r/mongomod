...
export type MmAggregationStage = StageMatch | StageGroup | StageSort | StageUnset | StageUnwind | StageVectorSearch | StageUnionWith | StageProject | StageLimit | StageSkip | StageLookup | StageAddFields | StageBucket | StageBucketAuto | StageChangeStream | StageChangeStreamSplitLargeEvent | StageCollStats | StageCount | StageCurrentOp | StageDensify | StageDocuments | StageFacet | StageFill | StageGeoNear | StageGraphLookup | StageIndexStats | StageListClusterCatalog | StageListLocalSessions | StageListSampledQueries | StageListSearchIndexes | StageListSessions | StageMerge | StageOut | StagePlanCacheStats | StageQuerySettings | StageQueryStats | StageRedact | StageReplaceRoot | StageReplaceWith | StageSample | StageSearch | StageSearchMeta | StageSet | StageSetWindowFields | StageShardedDataDistribution | StageSkip | StageSortByCount | StageVectorSearch;
export {};
