...
describe('MongoModel/utils/constructor.utils.ts', () => {
    ...
    describe('parseCustomMethods', () => {
        ...
        it('should preserve method context (this binding)', () => {
            const customMethods = {
                getThisValue: function(this: any) {
        ...
        it('should not bind methods if any validation fails', () => {
            ...
            try {
                ...
                // Error thrown for invalid method
            }

            // The invalidMethod property will be undefined since it was never bound
            // (it failed validation during loop iteration)
